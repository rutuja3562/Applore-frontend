...
export const Product = () => {
  ...
  const [orderValue, setOrderValue] = useState(
    searchParams.getAll("order") || 'desc'
  );
...
const HandleSelect=(e)=>{
  ...
  axios.get(`https://rbigbasket.herokuapp.com/vegetables?order=${e.target.value}`).then((res)=>{
      console.log(res.data.vegetables)
      setProducts(res.data.vegetables)
    }).catch((err)=>{
      console.log(err)
    })
  ...
  const brandValueHandler = async (value) => {
    axios.get(`https://rbigbasket.herokuapp.com/vegetables?brand=${value}`).then((res)=>{
      console.log(res.data.vegetables)
      setProducts(res.data.vegetables)
    }).catch((e)=>{
      console.log(e)
...
const packSizeHandler = async(value)=>{
  setPackSize(value);
  axios.get(`https://rbigbasket.herokuapp.com/vegetables?quantity=${value}`).then((res)=>{
    console.log(res.data.vegetables)
    setProducts(res.data.vegetables)
  }).catch((e)=>{
    console.log(e)
  ...
  //   }
  // };
const priceHandler=async(value,ord)=>{
    setPackSize(value);
    // axios.get(`https://rbigbasket.herokuapp.com/vegetables?sort=${value}&order=${ord}`).then((res)=>{
    //   console.log(res.data.vegetables)
    //   setProducts(res.data.vegetables)
    // }).catch((e)=>{
    //   console.log(e)
